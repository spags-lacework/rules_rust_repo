...
# buildifier: disable=bzl-visibility
load("//basic/ppp/crates:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        name = "basic",
        build_file = Label("//basic/ppp/crates:BUILD.bazel"),
        defs_module = Label("//basic/ppp/crates:defs.bzl"),
    )
